...
namespace DesignPatternsDemo
{
    ...
    public static class AdapterPatternDemo
    {
        ...
        {
            // returns false if payment is rejected
            bool ProcessProviderPayType(string merchantId, string cardNumber, string expiration, decimal amount);
        }

        public class StwipeAdapter : IPaymentProcessorAdapter
        {
            public bool ProcessProviderPayType(string merchantId, string cardNumber, string expiration, decimal amount)
            {
